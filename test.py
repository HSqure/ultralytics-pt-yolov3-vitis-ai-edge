...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-cfg', type=str, default='data/pedestrian.data', help='coco.data file path')
    parser.add_argument('--weights', type=str, default='weights/yolov3-pedestrian.pth', help='path to weights file')
